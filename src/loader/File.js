...
var File = new Class({
    ...
    function File (loader, fileConfig)
    {
        ...
        else if (typeof url === 'string' && !url.match(/^(?:blob:|data:|capacitor:\/\/|ionic:\/\/|http:\/\/|https:\/\/|\/\/)/))
        {
            url = loader.path + url;
        }
    ...
    onLoad: function (xhr, event)
    {
        ...
        var isLocalFile = xhr.responseURL && (xhr.responseURL.indexOf('file://') === 0 || xhr.responseURL.indexOf('capacitor://') === 0 || xhr.responseURL.indexOf('ionic://') === 0);
